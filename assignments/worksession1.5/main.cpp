...
struct {
	...
	float brightnessLower = 0.9f;
	float brightnessUpper = 0.2f;
...
int main() {
	...
	GLuint wat = ew::loadTexture("assets/wave_tex.png");
	GLuint specular = ew::loadTexture("assets/wave_spec.png");
	GLuint warp = ew::loadTexture("assets/wave_warp.png");
